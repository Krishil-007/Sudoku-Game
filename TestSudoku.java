...
class TestSudoku {
    public static void main(String args[]) {
        ...
        System.out.println("-------------------------------------------------------------");
        File f = new File("C:\\Users\\Admin\\Desktop\\highScore.txt");

        if (f.exists() == false) {
            try {
                FileWriter fw = new FileWriter("C:\\Users\\Admin\\Desktop\\highScore.txt");
        ...
        try {
            FileReader fr = new FileReader("C:\\Users\\Admin\\Desktop\\highScore.txt");
